...
#             self.models["encoder"].num_ch_enc, self.opt.scales, pw=True, oneLayer=True)
        
#         self.models["depth"] = networks.DepthDecoder(self.models["encoder"].num_ch_enc)
#         self.models["depth"] = networks.DepthDecoder(self.models["encoder"].num_ch_enc, skip2Conv=True)
        self.models["depth"] = networks.DepthDecoder(self.models["encoder"].num_ch_enc, pw=True, oneLayer=True)
        
#         self.models["depth"] = networks.MYDecoder(self.models["encoder"].num_ch_enc)
#         self.models["depth"] = networks.MYDecoder(self.models["encoder"].num_ch_enc, concatDepth=True)
#         self.models["depth"] = networks.MYDecoder(self.models["encoder"].num_ch_enc, firstConv=True, conv11=True)
#         self.models["depth"] = networks.MYDecoder(
#             self.models["encoder"].num_ch_enc, self.opt.scales, kernel_size=3, dw=False, pw=3)
#         self.models["depth"] = networks.MYDecoder(
#             self.models["encoder"].num_ch_enc, self.opt.scales, kernel_size=3, dw=True)
#         self.models["depth"] = networks.MYDecoder(
#             self.models["encoder"].num_ch_enc, self.opt.scales, kernel_size=5, dw=False)
#         self.models["depth"] = networks.MYDecoder(
#             self.models["encoder"].num_ch_enc, self.opt.scales, kernel_size=5, dw=True)
#         self.models["depth"] = networks.MYDecoder(
#             self.models["encoder"].num_ch_enc, self.opt.scales, kernel_size=35, dw=False)
#         self.models["depth"] = networks.MYDecoder(
#             self.models["encoder"].num_ch_enc, self.opt.scales, kernel_size=35, dw=False, more=True)
