...
__all__ = ['round_channels', 'Identity', 'Swish', 'HSigmoid', 'HSwish', 'get_activation_layer', 'conv1x1', 'conv3x3',
           'depthwise_conv3x3', 'ConvBlock', 'conv1x1_block', 'conv3x3_block', 'conv5x5_block', 'conv7x7_block', 'dwconv_block',
           'dwconv3x3_block', 'dwconv5x5_block', 'dwsconv3x3_block', 'dwsconv5x5_block', 'PreConvBlock', 'pre_conv1x1_block',
...
def dwsconv5x5_block(in_channels,
                     out_channels,
                     stride=1,
                     padding=2,
                     dilation=1,
                     ...
                     pw_activation=(lambda: nn.ReLU(inplace=True))):
    """
    5x5 depthwise separable version of the standard convolution block.
